...
* [Part 2: Advanced features](part-2-advanced-features/README.md)
  ...
  * [Using React components](part-2-advanced-features/using-react-components.md)
  * [Using REST services](part-2-advanced-features/using-rest-services/README.md)
    * [Legacy Rest Client](part-2-advanced-features/using-rest-services/legacy-rest-client.md)
...
* [Part 3: Server side interface](part-3-server-side-interface/README.md)
  ...
  * [Backend side](part-3-server-side-interface/server-side/README.md)
    ...
    * [Micronaut](part-3-server-side-interface/server-side/micronaut.md)
